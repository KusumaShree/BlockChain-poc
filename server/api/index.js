...
const scripts = require('../newScripts')
// const scriptsSample = require('../scripts/seed_sample_data')
// const scriptsUpdate = require('../scripts/run_sample_updates')
...
//my updates
router.post('/seedSampleData', handleBody(scripts.newData))
router.post('/runSampleUpdate', handleBody(scripts.updateData))
router.post('/createAgent', handleBody(scripts.createAgentWithName))
router.post('/createUser', handleBody(scripts.createUserFn))
