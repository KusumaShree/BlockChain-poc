...
const makeUpdateSubmitter = (count = 0) => () => {
  ...
  console.log(`Starting update set ${count + 1} of ${LIMIT}  --- ${SERVER}/records`)
  // Get current property values
  return request(`${SERVER}/records`)
    .then(res => {
      console.log(`response of records ${res}`)
